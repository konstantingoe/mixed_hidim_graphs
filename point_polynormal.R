...
nonpara_comparison_2 <- mclapply(mc.cores = numCores, 1:sim, function(k) nonparanormal_run(n=n[1], d=d[1], nlam=nlam, matexport = F,
                                                                                            namevector = c("binary" = T, "ordinal" = T, "poisson" = T),
...
nonpara_comparison_3 <- mclapply(mc.cores = numCores, 1:sim, function(k) nonparanormal_run(n=n[2], d=d[2], nlam=nlam, matexport = F,
                                                                                            namevector = c("binary" = T, "ordinal" = T, "poisson" = T),
                                                                                            unbalanced = .5, nonpara = F))
#plan(sequential)
...
nonpara_comparison_4 <- mclapply(mc.cores = numCores, 1:sim, function(k) nonparanormal_run(n=n[2], d=d[2], nlam=nlam, matexport = F,
                                                                                            namevector = c("binary" = T, "ordinal" = T, "poisson" = T),
                                                                                            unbalanced = .5, nonpara = T))
#plan(sequential)
...
nonpara_comparison_5 <- mclapply(mc.cores = numCores, 1:sim, function(k) nonparanormal_run(n=n[3], d=d[3], nlam=nlam, matexport = F, sparsity = .5,
                                                                                            namevector = c("binary" = T, "ordinal" = T, "poisson" = T),
                                                                                            unbalanced = .5, nonpara = F))
#plan(sequential)
...
nonpara_comparison_6 <- mclapply(mc.cores = numCores, 1:sim, function(k) nonparanormal_run(n=n[3], d=d[3], nlam=nlam, matexport = F, sparsity = .5,
                                                                                            namevector = c("binary" = T, "ordinal" = T, "poisson" = T),
                                                                                            unbalanced = .5, nonpara = T))
#plan(sequential)
...
nonpara_comparison_7 <- mclapply(mc.cores = numCores, 1:sim, function(k) nonparanormal_run(n=n[4], d=d[4], nlam=nlam, matexport = F, sparsity = .5,
                                                                                            namevector = c("binary" = T, "ordinal" = T, "poisson" = T),
                                                                                            unbalanced = .5, nonpara = F))
#plan(sequential)
...
nonpara_comparison_8 <- mclapply(mc.cores = numCores, 1:sim, function(k) nonparanormal_run(n=n[4], d=d[4], nlam=nlam, matexport = F, sparsity = .5,
                                                                                            namevector = c("binary" = T, "ordinal" = T, "poisson" = T),
                                                                                            unbalanced = .5, nonpara = T))
#plan(sequential)
