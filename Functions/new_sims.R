...
source("/dss/dsshome1/lxc0A/ge43doh2/Projects/mixed_hidim_graphs/Packages/packages.R")
source("/dss/dsshome1/lxc0A/ge43doh2/Projects/mixed_hidim_graphs/Functions/simulation_functions.R")

target_path <- "/dss/dsshome1/lxc0A/ge43doh2/Projects/mixed_hidim_graphs/simulation_results"
#### Binary benchamrk #####
