...
source("mixed_hidim_graphs/Functions/functions.R")
...
if (firstrun == T) {
    ...
    nonpara_comparison_2 <- future_lapply(future.seed = T, 1:sim, function(k) {
        serverrun.kendall.nonpara(
            t = t, n = n[1], d = d[1],
            nlam = nlam, matexport = F, countvar = F,
    ...
    nonpara_comparison_3 <- future_lapply(future.seed = T, 1:sim, function(k) {
        serverrun.kendall.nonpara(
            t = t, n = n[2], d = d[2],
            nlam = nlam, matexport = F, countvar = F,
            mode = "fan", param = .1, f_j = 1
    ...
    nonpara_comparison_4 <- future_lapply(future.seed = T, 1:sim, function(k) {
        serverrun.kendall.nonpara(
            t = t, n = n[2], d = d[2],
            nlam = nlam, matexport = F, countvar = F,
            mode = "fan", param = .1, f_j = 3
...
nonpara_comparison_5 <- future_lapply(future.seed = T, 1:sim, function(k) {
    serverrun.kendall.nonpara(
        t = t, n = n[3], d = d[3],
        nlam = nlam, matexport = F, countvar = F,
        mode = "fan", param = .1, f_j = 1
...
nonpara_comparison_6 <- future_lapply(future.seed = T, 1:sim, function(k) {
    serverrun.kendall.nonpara(
        t = t, n = n[3], d = d[3],
        nlam = nlam, matexport = F, countvar = F,
        mode = "fan", param = .1, f_j = 3
...
nonpara_comparison_7 <- future_lapply(future.seed = T, 1:sim, function(k) {
    serverrun.kendall.nonpara(
        t = t, n = n[4], d = d[4],
        nlam = nlam, matexport = F, countvar = F,
        mode = "fan", param = .1, f_j = 1
...
nonpara_comparison_8 <- future_lapply(future.seed = T, 1:sim, function(k) {
    serverrun.kendall.nonpara(
        t = t, n = n[4], d = d[4],
        nlam = nlam, matexport = F, countvar = F,
        mode = "fan", param = .1, f_j = 3
