...
\begin{condition}[Hessian statistical noise]\label{Hessian statistical noise}
    ...
    \end{equation*}
    Note that $\ell_{jk}$ corresponds to the respective log-likelihood functions in Definitions 2.4 and 2.5.% \ref{definition_case2} and \ref{definition_case3}.
...
\end{equation*}
as $L_0 < 1$. Consequently, the statements regarding the accuracy of the threshold estimates in Section 3.4 %\ref{sec::thresholds} %
still hold here.
